...
export default function Footer() {
    return (
        <div className="max-w-[82rem] px-4 mx-auto mt-24 lg:mt-64 relative">
            <div className="w-full h-full relative rounded-3xl lg:rounded-4xl overflow-hidden block pt-4 lg:pt-[32rem]">
                ...
                <div className="lg:block hidden absolute left-1/2 -translate-x-1/2 z-2 text-[6rem] lg:text-[18rem] top-60 lg:top-0 font-semibold title [background-image:radial-gradient(235.17%_97.94%_at_53.25%_-29.68%,#FFF_0%,rgba(255,255,255,0.00)_97%)] text-transparent bg-clip-text pointer-events-none select-none">
                    Genesis
                </div>
                
                <footer className="w-full px-5 pt-5 lg:pt-[5.5rem] pb-10 rounded-3xl lg:rounded-4xl overflow-hidden relative shadow-none bg-surface-0/80 dark:bg-surface-950/80 backdrop-blur-3xl">
                    <div className="max-w-[64rem] mx-auto flex lg:flex-row flex-col">
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-x-28 gap-y-7">
                            ...
                            <div className="p-2 flex flex-col gap-2">
                                <div className="px-3 py-2 text-surface-950 dark:text-surface-0 text-xl font-medium">Pages</div>
                                <div className="flex flex-col gap-2">
                                    {['About Us', 'Contact', 'Blog', 'Pricing', 'Auth', 'Not Found'].map((item) => (
                                        <a key={item} href="#" className="px-3 py-2 w-fit text-surface-600 dark:text-white/72 hover:text-surface-900 dark:hover:text-white hover:bg-surface-100 dark:hover:bg-white/10 rounded-full transition-all">
                                            {item}
                                        </a>
                                    ))}
                            ...
                            <div className="p-2 flex flex-col gap-2">
                                <div className="px-3 py-2 text-surface-950 dark:text-surface-0 text-xl font-medium">Legal</div>
                                <div className="flex flex-col gap-2">
                    ...
                    <div className="max-w-[64rem] mx-auto mt-4 px-4 lg:px-0">
                        <div className="w-full border-t border-surface-200 dark:border-surface-800"></div>
                        <div className="flex justify-between items-center py-6 text-sm text-surface-500 dark:text-surface-400">
                            <span>© 2024 Genesis Template. All rights reserved.</span>
                        </div>
                    </div>
                </footer>
            </div>
